...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Notification.recipients'
        db.add_column('reminders_notification', 'recipients', self.gf('django.db.models.fields.CharField')(default='all', max_length=15), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Notification.recipients'
        db.delete_column('reminders_notification', 'recipients')
    ...
    models = {
        ...
        'reminders.notification': {
            ...
            'recipients': ('django.db.models.fields.CharField', [], {'max_length': '15'}),
