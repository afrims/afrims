...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Notification.time_of_day'
        db.add_column('reminders_notification', 'time_of_day', self.gf('django.db.models.fields.TimeField')(default='9:00:00'), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Notification.time_of_day'
        db.delete_column('reminders_notification', 'time_of_day')
