...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'PatientAppointment'
        db.create_table('reminders_patientappointment', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('appt_date', self.gf('django.db.models.fields.DateField')()),
            ('confirmed_0day', self.gf('django.db.models.fields.CharField')(max_length=20, null=True, blank=True)),
            ('confirmed_4day', self.gf('django.db.models.fields.CharField')(max_length=20, null=True, blank=True)),
            ('confirmed_5day', self.gf('django.db.models.fields.CharField')(max_length=20, null=True, blank=True)),
            ('patient', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['reminders.Patient'])),
            ('confirmed', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal('reminders', ['PatientAppointment'])


    def backwards(self, orm):
        
        # Deleting model 'PatientAppointment'
        db.delete_table('reminders_patientappointment')
