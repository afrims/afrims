...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'SentNotification.date_to_send'
        db.add_column('reminders_sentnotification', 'date_to_send', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2011, 3, 15, 16, 21, 38, 70597)), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'SentNotification.date_to_send'
        db.delete_column('reminders_sentnotification', 'date_to_send')
