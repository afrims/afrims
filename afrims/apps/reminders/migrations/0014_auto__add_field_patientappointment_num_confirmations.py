...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'PatientAppointment.num_confirmations'
        db.add_column('reminders_patientappointment', 'num_confirmations', self.gf('django.db.models.fields.IntegerField')(default=0, max_length=2), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'PatientAppointment.num_confirmations'
        db.delete_column('reminders_patientappointment', 'num_confirmations')
    ...
    models = {
        ...
        'reminders.patientappointment': {
            ...
            'avg_num_notifications': ('django.db.models.fields.DecimalField', [], {'max_digits': '6', 'decimal_places': '5'}),
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'num_confirmations': ('django.db.models.fields.IntegerField', [], {'max_length': '2'}),
