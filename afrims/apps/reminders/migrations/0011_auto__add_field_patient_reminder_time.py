...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Patient.reminder_time'
        db.add_column('reminders_patient', 'reminder_time', self.gf('django.db.models.fields.TimeField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Patient.reminder_time'
        db.delete_column('reminders_patient', 'reminder_time')
