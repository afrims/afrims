...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Patient.contact'
        db.alter_column('reminders_patient', 'contact_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['rapidsms.Contact'], unique=True))

        # Adding unique constraint on 'Patient', fields ['contact']
        db.create_unique('reminders_patient', ['contact_id'])

        # Adding unique constraint on 'Patient', fields ['subject_number']
        db.create_unique('reminders_patient', ['subject_number'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'Patient', fields ['subject_number']
        db.delete_unique('reminders_patient', ['subject_number'])

        # Removing unique constraint on 'Patient', fields ['contact']
        db.delete_unique('reminders_patient', ['contact_id'])

        # Changing field 'Patient.contact'
        db.alter_column('reminders_patient', 'contact_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['rapidsms.Contact'], null=True))
