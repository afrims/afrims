...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'PatientAppointment.avg_num_notifications'
        db.add_column('reminders_patientappointment', 'avg_num_notifications', self.gf('django.db.models.fields.DecimalField')(default=0.0, max_digits=6, decimal_places=5), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'PatientAppointment.avg_num_notifications'
        db.delete_column('reminders_patientappointment', 'avg_num_notifications')
