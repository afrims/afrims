...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'PatientAppointment.cebu_confirmed_10day'
        db.add_column('reminders_patientappointment', 'cebu_confirmed_10day', self.gf('django.db.models.fields.CharField')(max_length=20, null=True, blank=True), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'PatientAppointment.cebu_confirmed_10day'
        db.delete_column('reminders_patientappointment', 'cebu_confirmed_10day')
    ...
    models = {
        ...
        'reminders.patientappointment': {
            ...
            'cebu_confirmed_10day': ('django.db.models.fields.CharField', [], {'max_length': '20', 'null': 'True', 'blank': 'True'}),
