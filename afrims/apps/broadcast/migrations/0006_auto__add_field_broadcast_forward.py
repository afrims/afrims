...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Broadcast.forward'
        db.add_column('broadcast_broadcast', 'forward', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='broadcasts', null=True, to=orm['broadcast.ForwardingRule']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Broadcast.forward'
        db.delete_column('broadcast_broadcast', 'forward_id')
