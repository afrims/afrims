...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ForwardingRule.source'
        db.alter_column('broadcast_forwardingrule', 'source_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['groups.Group']))


    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'ForwardingRule.source'
        raise RuntimeError("Cannot reverse this migration. 'ForwardingRule.source' and its values cannot be restored.")
