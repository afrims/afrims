...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ForwardingRule.forward_all_from_source'
        db.add_column('broadcast_forwardingrule', 'forward_all_from_source', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'ForwardingRule.forward_all_from_source'
        db.delete_column('broadcast_forwardingrule', 'forward_all_from_source')
    ...
    models = {
        'broadcast.broadcast': {
            ...
            'forward': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'broadcasts'", 'null': 'True', 'to': "orm['broadcast.ForwardingRule']"}),
        ...
        'broadcast.forwardingrule': {
            ...
            'forward_all_from_source': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'rule_type': ('django.db.models.fields.CharField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
            'source': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'source_rules'", 'null': 'True', 'to': "orm['groups.Group']"})
        },
        'groups.group': {
