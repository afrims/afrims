...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ForwardingRule.message'
        db.add_column('broadcast_forwardingrule', 'message', self.gf('django.db.models.fields.CharField')(default='', max_length=160, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'ForwardingRule.message'
        db.delete_column('broadcast_forwardingrule', 'message')
