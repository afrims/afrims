...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ForwardingRule.rule_type'
        db.add_column('broadcast_forwardingrule', 'rule_type', self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True), keep_default=False)

        # Adding field 'ForwardingRule.label'
        db.add_column('broadcast_forwardingrule', 'label', self.gf('django.db.models.fields.CharField')(max_length=150, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'ForwardingRule.rule_type'
        db.delete_column('broadcast_forwardingrule', 'rule_type')

        # Deleting field 'ForwardingRule.label'
        db.delete_column('broadcast_forwardingrule', 'label')
