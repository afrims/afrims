...
class BroadcastForm(forms.Form):
    ...
    contacts = ContactListField(max_length=None, error_messages={'required': 'Please select one or more contacts to send the message to'}) #list of contact ID's as selected by the Datatable present on the template page
